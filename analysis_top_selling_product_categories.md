...
Below, is a full breakdown of the SQL code used to return the top 10 product categories for each year. The full SQL code for this analysis can be found [here](sql_queries/top_selling categories.sql) and [here](sql_queries/revenue_contribution_of_t10.sql).
